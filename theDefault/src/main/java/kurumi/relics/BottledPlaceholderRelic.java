...
import kurumi.patches.relics.BottledPlaceholderField;
import kurumi.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static kurumi.DefaultMod.makeRelicOutlinePath;
import static kurumi.DefaultMod.makeRelicPath;
